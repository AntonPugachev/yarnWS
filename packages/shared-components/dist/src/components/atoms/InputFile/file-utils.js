...
var validateFile = function (file, options) {
    ...
    if (file && options) {
        ...
        if (isExecutable) {
            console.log("%c [\u041E\u0448\u0438\u0431\u043A\u0430] \u0412\u044B \u043F\u044B\u0442\u0430\u0435\u0442\u0435\u0441\u044C \u0437\u0430\u0433\u0440\u0443\u0437\u0438\u0442\u044C \u0438\u0441\u043F\u043E\u043B\u043D\u044F\u0435\u043C\u044B\u0439 \u0444\u0430\u0439\u043B (".concat(file.name, ")"), 'color: #FF5722');
            return {
                valid: false,
                error: "\u0412\u044B \u043F\u044B\u0442\u0430\u0435\u0442\u0435\u0441\u044C \u0437\u0430\u0433\u0440\u0443\u0437\u0438\u0442\u044C \u0438\u0441\u043F\u043E\u043B\u043D\u044F\u0435\u043C\u044B\u0439 \u0444\u0430\u0439\u043B (".concat(file.name, ")")
            };
        }
        if (options.accept !== undefined && options.accept !== '*') {
            var ext_2 = file.type.split('/');
            if (!options.accept.includes("".concat(ext_2[0]))) {
                valid = false;
                error = "\u041D\u0435\u0432\u0435\u0440\u043D\u044B\u0439 \u0442\u0438\u043F \u0444\u0430\u0439\u043B\u0430 (".concat(file.name, ")");
                console.log("%c [\u041E\u0448\u0438\u0431\u043A\u0430] \u041D\u0435\u0432\u0435\u0440\u043D\u044B\u0439 \u0442\u0438\u043F \u0444\u0430\u0439\u043B\u0430 (".concat(file.name, ")"), 'color: #FF5722');
            }
            else {
                var t = options.accept.split('/');
                if (t[1] !== '*' && !options.accept.includes("".concat(ext_2[1]))) {
                    valid = false;
                    error = "\u041D\u0435\u0432\u0435\u0440\u043D\u044B\u0439 \u0442\u0438\u043F \u0444\u0430\u0439\u043B\u0430 (".concat(file.name, ")");
                    console.log("%c [\u041E\u0448\u0438\u0431\u043A\u0430] \u041D\u0435\u0432\u0435\u0440\u043D\u044B\u0439 \u0442\u0438\u043F \u0444\u0430\u0439\u043B\u0430 (".concat(file.name, ")"), 'color: #FF5722');
                }

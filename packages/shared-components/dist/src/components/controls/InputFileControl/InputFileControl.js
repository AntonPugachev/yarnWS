...
var __1 = require("../../..");
var __2 = require("..");
var InputFileControl = function (_a) {
    ...
    return ((0, jsx_runtime_1.jsx)(Controller, { control: control, name: name, rules: rules, shouldUnregister: shouldUnregister, defaultValue: defaultValue, render: function (_a) {
            var _b = _a.field, ref = _b.ref, onChange = _b.onChange, fieldProps = __rest(_b, ["ref", "onChange"]);
            return ((0, jsx_runtime_1.jsx)(FormControl_1.default, __assign({ name: name, label: label, formState: formState }, formGroupProps, { children: (0, jsx_runtime_1.jsx)(__1.InputFile, __assign({}, props, fieldProps, { setFile: onChange })) })));
        } }));
};
exports.default = InputFileControl;

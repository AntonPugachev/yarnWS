...
var __1 = require("../../..");
var __2 = require("..");
var TimepickerControl = function (_a) {
    ...
    return ((0, jsx_runtime_1.jsx)(Controller, { control: control, name: name, rules: rules, shouldUnregister: shouldUnregister, defaultValue: defaultValue, render: function (_a) {
            ...
            return ((0, jsx_runtime_1.jsx)(FormControl_1.default, __assign({ name: name, label: label, formState: formState }, formGroupProps, { children: (0, jsx_runtime_1.jsx)(__1.Timepicker, __assign({}, props, { initialValue: value, onChangeValue: onChange })) })));
        } }));
};

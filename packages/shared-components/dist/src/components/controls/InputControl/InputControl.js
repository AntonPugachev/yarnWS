...
var HookFormProvider_1 = require("../HookFormProvider/HookFormProvider");
var InputControl = function (_a) {
    ...
    var Controller = (0, HookFormProvider_1.useHookFormController)();
    return ((0, jsx_runtime_1.jsx)(Controller, { control: control, name: name, rules: rules, shouldUnregister: shouldUnregister, defaultValue: defaultValue, render: function (_a) {
            var field = _a.field;
            return ((0, jsx_runtime_1.jsx)(FormControl_1.default, __assign({ name: name, label: label, formState: formState }, formGroupProps, { children: (0, jsx_runtime_1.jsx)(Input_1.default, __assign({}, props, field)) })));
        } }));
};

...
var InputNumber_1 = __importDefault(require("../../atoms/InputNumber/InputNumber"));
var __1 = require("..");
var InputNumberControl = function (_a) {
    ...
    return ((0, jsx_runtime_1.jsx)(Controller, { control: control, name: name, rules: rules, shouldUnregister: shouldUnregister, defaultValue: defaultValue, render: function (_a) {
            var _b = _a.field, onChange = _b.onChange, value = _b.value, fieldProps = __rest(_b, ["onChange", "value"]);
            return ((0, jsx_runtime_1.jsx)(FormControl_1.default, __assign({ name: name, label: label, formState: formState }, formGroupProps, { children: (0, jsx_runtime_1.jsx)(InputNumber_1.default, __assign({}, props, fieldProps, { defaultValue: value, onInputChange: function (value) { return onChange(+value.replace(/\s/g, '')); } })) })));
        } }));
};

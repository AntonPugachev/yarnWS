...
var CommentTile_1 = __importDefault(require("../../molecules/CommentTile/CommentTile"));
var __1 = require("..");
var CommentTileControl = function (_a) {
    ...
    return ((0, jsx_runtime_1.jsx)(Controller, { control: control, name: name, rules: rules, shouldUnregister: shouldUnregister, defaultValue: defaultValue, render: function (_a) {
            var _b = _a.field, _c = _b.value, value = _c === void 0 ? {} : _c, onChange = _b.onChange;
            return ((0, jsx_runtime_1.jsx)(FormControl_1.default, __assign({ name: name, label: label, formState: formState }, formGroupProps, { children: (0, jsx_runtime_1.jsx)(CommentTile_1.default, __assign({ initialFiles: value.attachedFiles, comment: value.debounceString, onDebounce: onChange }, props)) })));
        } }));
};
exports.default = CommentTileControl;

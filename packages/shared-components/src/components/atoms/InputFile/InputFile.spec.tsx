...
describe('Test <InputFile/> component', () => {
    ...
    it('should be initialFiles in chips', () => {
        ...
        expect(screen.getByText("pdfFile.pdf")).toBeInTheDocument();
        expect(screen.getByText("quston.png")).toBeInTheDocument();
        expect(screen.getByText("word_file.docx")).toBeInTheDocument();
    });
    ...
    it('should be upload file with attr accept',async () => {
        ...
        await waitFor(() =>{
            expect(screen.getByText('sweetfile.png')).toBeTruthy()
        })
    })
    ...
    it('should be multiple upload files',async () => {
        ...
        await waitFor(() =>{
            expect(screen.getByText('sweetfile.png')).toBeTruthy()
                ...
                expect(screen.getByText('sweetfile2.png')).toBeTruthy()
            }
        )
    })

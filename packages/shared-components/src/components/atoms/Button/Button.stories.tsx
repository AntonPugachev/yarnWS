...
export const Demo: Story = () => {
  const getButtons = (props: IButtonProps) => {
    return (
      <>
        <Button {...props} size='xl' aria-label={props.preloader ? 'Button 56' : undefined}>
          Button 56
        </Button>
        <Button {...props} size='l' aria-label={props.preloader ? 'Button 48' : undefined}>
          Button 48
        </Button>
        <Button {...props} size='m' aria-label={props.preloader ? 'Button 40' : undefined}>
          Button 40
        </Button>
        <Button {...props} size='s' aria-label={props.preloader ? 'Button 32' : undefined}>
          Button 32
        </Button>
      </>
    );
  ...
  const getIconButtons = (props: IButtonProps) => {
    return (
      <>
        <Button {...props} size='xl' aria-label='Button 56'>
          <AllIconPlace />
        </Button>
        <Button {...props} size='l' aria-label='Button 48'>
          <AllIconPlace />
        </Button>
        <Button {...props} size='m' aria-label='Button 40'>
          <AllIconPlace />
        </Button>
        <Button {...props} size='s' aria-label='Button 32'>
          <AllIconPlace size='xxs' />
        </Button>
      </>
    );
  };
  ...
  return (
    <StoryDocs>
      ...
      >
        <Button size='xl' startAdornment={<AllIconPlace size='xs' />}>
          Button 56
        </Button>
        <Button size='l' startAdornment={<AllIconPlace size='xs' />}>
          Button 48
        </Button>
        <Button size='m' startAdornment={<AllIconPlace size='xs' />}>
          Button 40
        </Button>
        <Button size='s' startAdornment={<AllIconPlace size='xxs' />}>
          Button 32
        </Button>
        <Button size='xl' endAdornment={<AllIconPlace size='xs' />}>
          Button 56
        </Button>
        <Button size='l' endAdornment={<AllIconPlace size='xs' />}>
          Button 48
        </Button>
        <Button size='m' endAdornment={<AllIconPlace size='xs' />}>
          Button 40
        </Button>
        <Button size='s' endAdornment={<AllIconPlace size='xxs' />}>
          Button 32
        </Button>
        ...
        <Button size='xl' buttonType='text' startAdornment={<AllIconPlace size='xs' />}>
          Text button 56
        </Button>
        <div /> <div />
        <Button size='s' buttonType='text' startAdornment={<AllIconPlace size='xxs' />}>
          Text button 32
        </Button>
      </div>
      ...
      >
        ...
        <StoryDocsLabel>Default</StoryDocsLabel>
        <Button buttonType={'text'} size='xl'>
          Button 56
        </Button>
        <Button buttonType={'text'} size='s'>
          Button 32
        </Button>
        <StoryDocsLabel>Disabled</StoryDocsLabel>
        <Button buttonType={'text'} disabled size='xl'>
          Button 56
        </Button>
        <Button buttonType={'text'} disabled size='s'>
          Button 32
        </Button>
        <StoryDocsLabel>Loading</StoryDocsLabel>
        <Button buttonType={'text'} preloader size='xl' aria-label='Button 56'>
          Button 56
        </Button>
        <Button buttonType={'text'} preloader size='s' aria-label='Button 32'>
          Button 32
        </Button>
        ...
        <StoryDocsLabel>Default</StoryDocsLabel>
        <Button size='xl' buttonType='text' startAdornment={<AllAdd size='xs' />}>
          Text button 56
        </Button>
        <Button size='s' buttonType='text' startAdornment={<AllAdd size='xxs' />}>
          Text button 32
        </Button>
      </div>
    </StoryDocs>
...
export const Playground: Story = (args: IButtonProps) => {
  ...
  return (
    <StoryContainer>
      <StoryRow>
        <Button {...args}>{args.buttonType === 'icon' || args.buttonType === 'iconFill' ? 'i' : 'Button'}</Button>
      </StoryRow>
      <StoryRow>
